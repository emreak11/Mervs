...
if __name__ == "__main__":
    ...
    for seed0 in (0, 1):
        ...
        print(f"\n=== COARSE SCAN | seed0 = {seed0} ===", flush=True)
        ...
        plot_heatmap(
            ...
            taus,
            rhos,
            title=f"Δdefect (alt - global) | seed0={seed0}",
            cbar_label="Δdefect",
            fname=f"phase_delta_coarse_seed{seed0}.png",
        )
